import { Container, Box, View, Text, Avatar, HStack, Center } from 'native-base'
    ...
    <Box bg="#0D0D0D" pt={12} px={4} h="100vh">
      ...
      <Box h='100%' w={'100%'} mt={10}>
        <HStack space={6} px={8} p={4} height={'20%'} w='100%'>
          <Box w='50%' bg='#212121' h='100%' borderRadius={20} pl={'14%'} pt={'6%'}>
            <FontAwesome name="book" size={90} color="white" />
            <Text color='white' fontWeight='bold' mt={2}>Lecciones</Text>

          </Box>

          <Box w='50%' bg='#212121' h='100%' borderRadius={20} pl={'14%'} pt={'6%'}>
            <FontAwesome name="calendar-minus-o" size={90} color="white" />
            <Text color='white' fontWeight='bold' mt={2}>Asistencia</Text>
          </Box>
        </HStack>
        <HStack space={6} px={8} p={4} height={'20%'} w='100%'>
          <Box w='50%' bg='#212121' h='100%' borderRadius={20} pl={'14%'} pt={'6%'}>
            <MaterialCommunityIcons name="ab-testing" size={90} color="white" />
            <Text color='white' fontWeight='bold' mt={2}>Pruebas</Text>
          </Box>
          <Box w='50%' bg='#212121' h='100%' borderRadius={20} pl={'14%'} pt={'6%'}>
            <Ionicons name="settings" size={90} color="white" />
            <Text color='white' fontWeight='bold' mt={2}>Configuración</Text>
          </Box>
        </HStack>
      </Box>
    </Box>
